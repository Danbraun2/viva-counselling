...
export const metadata = {
  title: "Terms of Use",
  description:
    "The terms and conditions for using the VIVA Counselling website.",
};
...
export default function TermsPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 pb-24 pt-16 sm:px-6 sm:pt-24 lg:px-8 lg:pt-32">
      ...
      <h1 className="mt-3 font-serif text-4xl leading-tight sm:text-5xl">Terms of Use</h1>
      ...
      <div className="prose prose-neutral mt-10 max-w-none space-y-6 text-base leading-relaxed text-foreground/90">
        ...
        <h2 className="font-serif text-2xl">Not medical advice</h2>
        <p>
